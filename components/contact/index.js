            ...
            <div className="form">
                ...
                <form id="contact-form">
                    ...
                    <div className="flex-rev">
                        <input autoComplete="off" type="text" required placeholder="Vava Krishnan" name="user_name" id="name" />
                        <label htmlFor="name">Full Name</label>
                    </div>
                    <div className="flex-rev">
                        <input autoComplete="off" type="email" required placeholder="vkrishnan1991@gmail.com" name="user_email" id="email" />
                        <label htmlFor="email">Your Email</label>
                    </div>

                    <div className="flex-rev">
                        <textarea data-gramm_editor="false" autoComplete="off" required placeholder="I have an idea for a project...." name="message" id="message" ></textarea>
                        <label htmlFor="message">Email Message</label>
                    </div>
                    <input type="submit" className='button' value="Send Email"></input>
                    <h1 className="thankyou" id="thankyou">
                        Thank You
                    </h1>
                </form>
            </div>
